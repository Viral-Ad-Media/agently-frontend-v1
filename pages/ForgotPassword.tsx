  ...
  return (
    <main className="auth-page min-h-svh lg:h-svh lg:overflow-hidden">
      <div className="mx-auto flex min-h-svh w-full max-w-[1080px] flex-col px-3 py-3 sm:px-5 lg:h-svh lg:min-h-0 lg:py-4">
        <div className="mb-3 flex h-12 items-center justify-between rounded-full border border-[#232f3e]/10 bg-white/76 px-4 shadow-[0_12px_36px_rgba(35,47,62,0.06)] backdrop-blur-xl">
          <Link
            to="/"
        ...
        <div className="grid flex-1 overflow-hidden rounded-[2rem] border border-white/70 bg-white/74 shadow-[0_26px_78px_rgba(35,47,62,0.11)] backdrop-blur-xl lg:min-h-0 lg:grid-cols-[0.86fr_1.14fr]">
          <section className="relative hidden overflow-hidden bg-[#232f3e] p-7 text-white lg:flex lg:flex-col lg:justify-between">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_8%_0%,rgba(255,85,39,0.43),transparent_30%),radial-gradient(circle_at_92%_16%,rgba(255,255,255,0.12),transparent_26%),linear-gradient(145deg,rgba(255,255,255,0.07),transparent_44%)]" />
            ...
            <div className="w-full max-w-[450px]">
              <div className="mb-5 text-center lg:text-left">
                <div className="mb-3 flex items-center justify-center gap-2 lg:justify-start">
                  <span className="flex h-9 w-9 items-center justify-center rounded-2xl bg-[#ff5527] text-white shadow-[0_14px_30px_rgba(255,85,39,0.22)]">
                    <RecoveryIcon />
                  </span>
                ...
                <h1 className="font-display text-[clamp(2rem,3.1vw,2.65rem)] font-medium leading-[1.02] tracking-[-0.055em] text-[#232f3e]">
                  {isResetMode
                    ? "Create a new password"
                    : "Reset your password"}
                </h1>
                <p className="mt-2.5 text-[14px] font-normal leading-[20px] text-[#232f3e]/70">
                  {isResetMode
              ...
              <div className="rounded-[1.6rem] border border-[#232f3e]/10 bg-[#fbfaf4]/94 p-4 shadow-[0_18px_54px_rgba(35,47,62,0.1)] backdrop-blur-xl sm:p-5">
                {completed ? (
                  <div className="py-6 text-center animate-in fade-in zoom-in">
                    ...
                    <Link
                      to="/login"
                      className="mt-5 inline-flex w-full items-center justify-center rounded-full bg-[#232f3e] px-5 py-3 text-sm font-medium text-white shadow-[0_18px_40px_rgba(35,47,62,0.16)] transition hover:-translate-y-0.5 hover:bg-[#1a2633]"
                    >
                      Return to login
                    </Link>
                  </div>
                  ...
                  <div className="py-6 text-center animate-in fade-in zoom-in">
                    ...
                    {devResetUrl && (
                      <a
                        href={devResetUrl}
                        className="mt-5 block w-full rounded-full border border-[#232f3e]/12 px-4 py-3 text-sm font-medium text-[#232f3e]/72 transition hover:border-[#ff5527]/40 hover:text-[#ff5527]"
                      >
                    ...
                    <button
                      ...
                      className="mt-4 text-sm font-medium text-[#ff5527] hover:underline"
                    >
                  ...
                  <form onSubmit={confirmReset} className="space-y-3">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="flex w-full items-center justify-center gap-2 rounded-full bg-[#232f3e] px-5 py-3 text-sm font-medium text-white shadow-[0_18px_40px_rgba(35,47,62,0.16)] transition hover:-translate-y-0.5 hover:bg-[#1a2633] disabled:translate-y-0 disabled:opacity-50"
                    >
                      {loading ? (
              ...
              <p className="mt-3 text-center text-[13px] font-normal text-[#232f3e]/60">
