    ...
    <div className="animate-fade-up space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-0.5">
            Provision Twilio numbers from your master account — tenants don't
            need their own Twilio credentials
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-card p-6">
          ...
          {busy === "owned" ? (
            ...
            <div className="rounded-2xl border-2 border-dashed border-slate-200 py-12 text-center">
              <div className="text-3xl mb-3">📭</div>
              <p className="text-sm font-bold text-slate-400">
                No numbers on this Twilio account yet.
              </p>
              <p className="text-xs text-slate-300 mt-1">
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 flex gap-3">
        ...
        <div className="text-xs text-slate-500 leading-relaxed">
          <strong className="text-slate-700">How it works:</strong> Numbers are
          purchased on your master Twilio account and assigned to individual
          voice agents. Each tenant's inbound calls are routed through your{" "}
          <strong>ConversationRelay</strong> server using their agent's
          configuration. Tenants never see your Twilio credentials.
        </div>
      </div>
    </div>
  );
