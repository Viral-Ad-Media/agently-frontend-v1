              ...
              <button
                onClick={() =>
                  setSelectedScheduleIds((current) =>
                    current.length === allScheduleIds.length
                      ? []
                      : allScheduleIds,
                  )
                }
              ...
              {preview && (
                <div className="mt-4 rounded-3xl border border-emerald-100 bg-emerald-50 p-4">
                  <p className="text-sm font-black text-emerald-800">
                    {getPreviewTotal(preview)} calls generated
                  </p>
          ...
          <div className="max-h-[85vh] w-full max-w-2xl overflow-auto rounded-[2rem] bg-white p-6 shadow-2xl">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                className="rounded-xl bg-slate-100 px-3 py-2 text-xs font-black uppercase tracking-widest text-slate-500"
              >
                Close
              </button>
            </div>
            <div className="mt-5 grid grid-cols-1 gap-3 text-sm md:grid-cols-2">
              ...
              <p>
                <span className="font-black">Timezone:</span>{" "}
            ...
            <pre className="mt-5 max-h-80 overflow-auto rounded-2xl bg-slate-50 p-4 text-[11px] text-slate-500">
          ...
          <div className="w-full max-w-md rounded-[2rem] bg-white p-6 shadow-2xl">
            ...
            <p className="mt-2 text-sm text-slate-500">
              ...
              {deleteTarget.id === "bulk"
                ? `You are deleting ${selectedScheduleIds.length} selected schedules.`
                : `You are deleting ${deleteTarget.name || "this schedule"}.`}
            </p>
            <div className="mt-6 flex justify-end gap-2">
              <button
                onClick={() => setDeleteTarget(null)}
                className="rounded-xl border border-slate-200 px-4 py-2 text-xs font-black uppercase tracking-widest text-slate-500"
              >
                Cancel
              </button>
              <button
