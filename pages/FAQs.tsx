...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "No. Answering calls is one workflow, but Agently is a full AI team for your business, handling outbound campaigns, qualification, no-show recovery, cart recovery, onboarding, and post-call follow-up.",
  },
  {
